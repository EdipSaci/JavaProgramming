...
public class EmployeeObjects {
    public static void main(String[] args) {
        ...
        tester.work();//Ali is testing the app
        tester.sleep();//Ali sleeps 8 hours
        tester.bugReport();//Ali is creating bug report
        tester.eat();//Ali is eating baklava

        System.out.println("-----------------------------------");

        developer.work();//Alex is writing cod
        developer.sleep();//Alex is sleeps 6 hours
        // developer.bugReport();
        ...
        teacher.sleep();//Angel sleeps 7 hours
